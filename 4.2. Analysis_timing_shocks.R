...
subsamples=list(Exchange_rate=c(
                "Currency_crisis_norm","Reduction_reserves_norm","Balance_payment_crisis_norm","Expectations_norm")
              ...
              # , Commodity=c("Commodity_crisis_norm","Natural_disaster_norm","trade_crisis_norm"),
...
output[["Timing_crisis_fig"]]$Exchange_rate
