shocks=c('Wars','Natural_disaster','Commodity_crisis','Political_crisis','Banking_crisis',
         'Financial_crisis','Inflation_crisis','trade_crisis','Crisis_contagion','World_outcomes','Contagion',
         'Expectations','Balance_payment_crisis','Reduction_reserves','Currency_crisis','Severe_recession','Soft_recession','Expansion',
         'Fiscal_outcomes','Sovereign_default')
